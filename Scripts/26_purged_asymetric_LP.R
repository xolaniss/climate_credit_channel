...
# Output folders -------------------------------------------------------------
dir.create(here("Outputs", "LP_unsmoothed_asym_purged"), showWarnings = FALSE, recursive = TRUE)
dir.create(here("Outputs", "LP_unsmoothed_asym_purged", "IRFs"), showWarnings = FALSE, recursive = TRUE)
dir.create(here("Outputs", "LP_unsmoothed_asym_purged", "Plots"), showWarnings = FALSE, recursive = TRUE)
dir.create(here("Outputs", "LP_unsmoothed_asym_purged", "Tables"), showWarnings = FALSE, recursive = TRUE)
dir.create(here("Outputs", "LP_unsmoothed_asym_purged", "Combined_Plots"), showWarnings = FALSE, recursive = TRUE)
...
write_rds(
  artifacts,
  file = here("Outputs", "artifacts_lp_unsmoothed_asym_purged.rds")
)
