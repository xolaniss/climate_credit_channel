...
# Export --------------------------------------------------------------
artifacts <- list(
  model_data_controls_tbl = model_data_controls_tbl
)

write_rds(
  artifacts,
  file = here("Outputs","artifacts_model_data_controls.rds")
)