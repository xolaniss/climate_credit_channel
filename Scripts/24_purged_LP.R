...
# Output folders -------------------------------------------------------------
dir.create(here("Outputs", "LP_unsmoothed_purged"), showWarnings = FALSE, recursive = TRUE) #if path doesnt exist, create it
dir.create(here("Outputs", "LP_unsmoothed_purged", "IRFs"), showWarnings = FALSE, recursive = TRUE)
dir.create(here("Outputs", "LP_unsmoothed_purged", "Plots"), showWarnings = FALSE, recursive = TRUE)
dir.create(here("Outputs", "LP_unsmoothed_purged", "Tables"), showWarnings = FALSE, recursive = TRUE)
dir.create(here("Outputs", "LP_unsmoothed_purged", "Combined_Plots"), showWarnings = FALSE, recursive = TRUE)
...
write_rds(
  artifacts,
  file = here("Outputs", "artifacts_lp_unsmoothed_purged.rds")
)
